const setting = [
  {
    setting: {
      ...
      shop_name: "JáPizza",
      address: "R. das Escadinhas 5, 8500-132, Portugal",
      company_name: "JáPizza ltd",
      vat_number: "",
      post_code: "8500-132",
      contact: "+351 912 827 537",
      email: "contato@japizza.pt",
      website: "https://japizza-loja.vercel.app/",
      default_currency: "€",
  ...
  },
  {
    setting: {
      ...
      home: {
        ...
        place_holder_img: "",
        discount_title: {
          pt: "Último Super Desconto Código Cupão Ativo",
        },
        promotion_title: {
          pt: "Tradição e Sabor em Cada Fatia",
        },
        promotion_description: {
          pt: "Na nossa pizzaria, todas as pizzas são preparadas no autêntico forno a lenha, garantindo uma massa crocante, fumegante e cheia de sabor. Uma experiência que remete à tradição italiana, aqui mesmo em Mexilhoeira!",
        },
        promotion_button_name: {
          pt: "Reserve Já"
        },
        promotion_button_link: "/search?category=pizzas",
        feature_title: {
          pt: "Os Mais Pedidos",
        },
        feature_description: {
          pt: "Conheça nossas categorias de produtos"
        },
        feature_product_limit: 18,
        popular_title: {
          pt: "Populares na JáPizza",
        },
        popular_description: {
          pt: "Conheça nossos produtos em alta"
        },
        popular_product_limit: 18,
        quick_delivery_subtitle: {
          pt: "Pizzas da melhor qualidade com Produtos Organicos",
        },
        quick_delivery_title: {
          pt: "Chegamos até si!"
        },
        quick_delivery_description: {
          pt: "Quer saborear uma pizza deliciosa sem sair de casa? O nosso serviço de entrega rápida garante que a sua pizza chega quentinha e cheia de sabor, diretamente à sua porta. Faça o seu pedido e desfrute da qualidade que merece, sem esperas!"
        },
        quick_delivery_button: {
          pt: "Faça Pedido Agora"
        },
        quick_delivery_link: "#",
        quick_delivery_img:
          "https://res.cloudinary.com/ahossain/image/upload/v1697688032/settings/delivery-boy_rluuoq.webp",
        latest_discount_title: {
          pt: "Produtos com Descontos",
        },
        latest_discount_description: {
          pt: "Conheça e aproveite as ofertas",
        },
        latest_discount_product_limit: 18,
        daily_need_title: {
          pt: "Obtenha suas ofertas diárias do Nossa Pizzaria JáPizza",
        },
      ...
      about_us: {
        ...
        top_title: {
          pt: "Bem-vindo a JáPizza",
        },
        top_description: {
          pt: "Aproveite holisticamente as métricas paralelas e o ROI funcional. Incentivar progressivamente as aplicações de última geração para um capital intelectual eficiente. Aproveite de forma fiável a quota de mercado diferenciada existente através de esquemas de ponta. Procrastine proactivamente os paradigmas de construção de equipas, coordene o cliente centrado, total e transparente internamente. \n\nAbrace dinamicamente diversos paradigmas de serviço ao cliente e de base instalada. Aproveite com credibilidade as experiências em toda a empresa para dados de ponta a ponta. Crie alinhamentos flexíveis e arquiteturas económicas com marca profissional. Incentivar com entusiasmo comunidades integradas com métricas revolucionárias facilitadas com áreas temáticas estratégicas"
        },
        card_one_title: {
          pt: "10K",
        },
        ...
        middle_description_one: {
          pt: "Descrição média 1"
        },
        middle_description_two: {
          pt: "Descrição média 2"
        },
        founder_title: {
          pt: "Nossa Equipe",
        },
        founder_description: {
          pt: "Descrição de equipe 1",
        },
        founder_one_name: {
          pt: "Niamh Shea"
        },
      ...
      contact_us: {
        ...
        email_box_email: {
          pt: "contato@japizza.pt"
        },
        email_box_text: {
          pt: "Interativamente crescendo empoderado para o processo centrado total de ligação.",
        },
        call_box_title: {
          pt: "Ligue para Nós",
        },
      ...
      faq: {
        ...
        description_one: {
          pt: "Sim. Pode cancelar a sua subscrição a qualquer momento. A sua subscrição continuará ativa até ao final do prazo atual (mês ou ano), mas não será renovada automaticamente. A menos que elimine a sua conta manualmente, a sua conta e todos os dados serão eliminados 60 dias a partir do dia em que a sua subscrição se tornar inativa."
        },
        faq_two: {
          pt: "Posso cancelar a minha subscrição a qualquer momento?",
        },
        description_two: {
          pt: "Inicie canais distintos e sem erros com ROI altamente eficiente. Visualize intrinsecamente dados de classe mundial através das melhores práticas. Capacite os retalhistas eletrónicos com eficiência após serviços entre unidades. Acelere exclusivamente os retalhistas eletrónicos através de interfaces cooperativas. Monotonectalmente miocardinar meta-serviços direcionados para o cliente, enquanto cenários sem erros"
        },
        faq_three: {
          pt: "Qual o método de pagamento que deve aceitar?"
        },
        description_three: {
          pt: "Envolva-se holisticamente em nichos de mercado específicos antes da colaboração e da partilha de ideias. Facilitar de forma fosforescente aplicações paralelas com imperativos únicos. Plagie proactivamente entregas funcionalizadas através de soluções baratas. Adote de forma colaborativa infomediários habilitados para a web em vez de procedimentos de teste diversos."
        },
        faq_four: {
          pt: "Posso cancelar minha assinatura a qualquer momento?",
        },
        description_four: {
          pt: "Impacte continuamente os imperativos contínuos para as melhores práticas. Facilitar de forma fosforescente aplicações paralelas com imperativos únicos. Plagie proactivamente entregas funcionalizadas através de soluções baratas. Adote de forma colaborativa infomediários habilitados para a web em vez de procedimentos de teste diversos."
        },
        faq_five: {
          pt: "O que é o dimensionamento automático do JáPizza EC2?"
        },
        description_five: {
          pt: "Descriçã 5"
        },
        faq_six: {
          pt: "Quais são os benefícios de utilizar o afiliado JáPizza?"
        },
        description_six: {
          pt: "Descriçã 6"
        },
      ...
      slider: {
        ...
        first_title: {
          pt: "Sabores que Conquistam!",
        },
        first_description: {
          pt: "Experimente as pizzas mais autênticas da região, feitas com ingredientes frescos e muito amor."
        },
        first_button: {
          pt: "Peça Já"
        },
        first_link: "/search?category=pizzas",
        second_img:
          "https://res.cloudinary.com/ahossain/image/upload/v1697688491/settings/slider-2_o6aezc.jpg",
        second_title: {
          pt: "Pão de Alho Irresistível!"
        },
        second_description: {
          pt: "Crocante por fora, macio por dentro e cheio de sabor. O acompanhamento perfeito para a sua pizza."
        },
        second_button: {
          pt: "Experimente"
        },
        second_link: "/search?category=lanches",
        third_img:
        ...
        third_description: {
          pt: "Ambiente acolhedor, boa música e o sabor inconfundível das nossas pizzas. Estamos à sua espera!"
        },
        third_button: {
          pt: "Reserve Já"
        },
        third_link: "https://wa.link/ie33aj",
        four_img: "https://i.postimg.cc/rscqZJNz/slider-1.webp",
        four_title: {
          pt: "Promoções Especiais"
        },
        four_description: {
          pt: "Explore nossa categoria de cupons e aproveite!"
        },
        four_button: {
          pt: "Aproveite Já"
        },
      ...
      footer: {
        ...
        shipping_card: {
          pt: "Gratuito Envio de 50,00 €",
        },
        support_card: {
          pt: "Suporte 24/7  Qualquer Hora",
        },
        payment_card: {
          pt: "Pagamento Seguro, 100% Seguro",
        },
        offer_card: {
          pt: "Oferta Atual: Ate 20% de Desconto",
        },
        block1_title: {
          pt: "Empresa",
        },
        ...
        block1_sub_link4: "#",
        block2_title: {
          pt: "Notícias Recentes",
        },
        block2_sub_title1: {
          pt: "Pizzas , Bebidas e Lanches"
        },
        ...
        block2_sub_title3: {
          pt: "Descrição de bloco 3",
        },
        block2_sub_link3: "/search?category=milk-dairy",
        block2_sub_title4: {
          pt: "Descrição de bloco 4",
        },
      ...
      slug: {
        ...
        card_description_one: {
          pt: "Envio Gratuito para todos os pedidos acima de €50",
        },
        ...
        card_description_four: {
          pt: "Garantia de devolução de 7 dias",
        },
      ...
      seo: {
        ...
        meta_keywords: "e-commerce, online store, pizza",
        meta_title:
          "A Pizza que você nunca vai esquecer",
        meta_url: "https://japizza-loja.vercel.app/",
      },
    },
  ...
  },
  {
    setting: {
      ...
      facebook_secret: "",
      nextauth_secret: "",
      next_api_base_url: "https://japizza-backend.onrender.com/api",
      stripe_key: "",
      stripe_secret: "",
      stripe_status: false,
